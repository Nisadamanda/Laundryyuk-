...
<head>
    ...
    <!-- color CSS -->
    <link href="../assets/css/colors/def.css" id="theme" rel="stylesheet">
    <!-- DataTables -->
            ...
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        ...
                        ?>
                        <a class="profile-pic" href="#"> <img src="../assets/plugins/images/users/user.png" alt="user-img" width="36" class="img-circle">
                            <b class="hidden-xs">KASIR <?= $_SESSION['username']; ?> | <?= $outlet['nama_outlet']; ?></b>
                        </a>
                    </li>
                </ul>
            </div>
