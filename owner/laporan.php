...
$hari = ambilsatubaris($conn,"SELECT SUM(total_harga) AS total FROM detail_transaksi INNER JOIN transaksi ON transaksi.id_transaksi = detail_transaksi.transaksi_id WHERE status_bayar = 'dibayar' AND DAY(tgl_pembayaran) = DAY(NOW())");
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info">
                ...
                <ul class="list-inline two-part">
                    ...
                    <li class="text-right"><i class="ti-arrow-up text-success"></i> <span class=" text-success"><?= htmlspecialchars($tahun['total']); ?></span></li>
                </ul>
            </div>
        </div>
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info">
                ...
                <ul class="list-inline two-part">
                    ...
                    <li class="text-right"><i class="ti-arrow-up text-purple"></i> <span class=" text-purple"><?= htmlspecialchars($bulan['total']); ?></span></li>
                </ul>
            </div>
        </div>
        <div class="col-lg-4 col-sm-6 col-xs-12">
